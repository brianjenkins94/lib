...
if (isEntry(import.meta)) {
	...
	const config = juvy({
		...
		"port": { "format": "port", "default": discovered.port, "short": "p", "env": "PREVIEW_PORT", "doc": "Port to listen on ($PREVIEW_PORT, else $PORT)." },
		"base": { "format": String, "default": "", "short": "b", "env": "PAGES_BASE", "doc": "Mount under /<base> (mirror a Pages /<repo>/ deploy; $PAGES_BASE)." }
	});
