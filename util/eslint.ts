...
const errors = {
	"ts/naming-convention": ["error", { "selector": "default", "format": ["camelCase"] }, { "selector": ["function", "variable"], "format": ["camelCase", "PascalCase", "UPPER_CASE"], "leadingUnderscore": "allowSingleOrDouble" }, { "selector": ["parameter", "variable"], "modifiers": ["destructured"], "format": null }, { "selector": "objectLiteralProperty", "format": null }, { "selector": ["classProperty", "parameter"], "format": ["camelCase", "PascalCase"], "leadingUnderscore": "allow" }, { "selector": ["typeLike", "enumMember"], "format": ["PascalCase"] }],
...
const isOff = (value: unknown): boolean => { const level = Array.isArray(value) ? value[0] : value; return level === "off" || level === 0; };
